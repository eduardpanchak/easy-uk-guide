...
export const translations = {
  en: {
    ...
    account: {
      ...
      upgrade: 'Upgrade',
      enableBusiness: 'Enable Business Account',
      enableBusinessDesc: 'Add and manage your own services, get statistics, and reach more customers',
      businessEnabled: 'Business Account enabled successfully!',
      businessConfirmTitle: 'Upgrade to Business Account',
      businessConfirmBody: 'Business accounts unlock tools for promoting services and reaching more clients. Do you want to switch to a Business Account?',
      businessConfirmYes: 'Yes, upgrade',
      businessConfirmCancel: 'Cancel',
      businessSuccessTitle: 'Welcome to Business!',
      businessSuccessBody: 'Congratulations! Your account has been successfully upgraded. You can now add services and grow your client base.',
      businessSuccessContinue: 'Continue',
      business: 'Business',
  ...
  uk: {
    ...
    account: {
      ...
      upgrade: 'Покращення',
      enableBusiness: 'Увімкнути бізнес-акаунт',
      enableBusinessDesc: 'Додавайте та керуйте своїми послугами, отримуйте статистику та залучайте більше клієнтів',
      businessEnabled: 'Бізнес-акаунт успішно увімкнено!',
      businessConfirmTitle: 'Перейти на бізнес-акаунт',
      businessConfirmBody: 'Бізнес-акаунти відкривають інструменти для просування послуг та залучення більшої кількості клієнтів. Бажаєте перейти на бізнес-акаунт?',
      businessConfirmYes: 'Так, оновити',
      businessConfirmCancel: 'Скасувати',
      businessSuccessTitle: 'Ласкаво просимо до бізнесу!',
      businessSuccessBody: 'Вітаємо! Ваш акаунт успішно оновлено. Тепер ви можете додавати послуги та розширювати клієнтську базу.',
      businessSuccessContinue: 'Продовжити',
      business: 'Бізнес',
  ...
  ru: {
    ...
    account: {
      ...
      upgrade: 'Улучшение',
      enableBusiness: 'Включить бизнес-аккаунт',
      enableBusinessDesc: 'Добавляйте и управляйте своими услугами, получайте статистику и привлекайте больше клиентов',
      businessEnabled: 'Бизнес-аккаунт успешно включён!',
      businessConfirmTitle: 'Перейти на бизнес-аккаунт',
      businessConfirmBody: 'Бизнес-аккаунты открывают инструменты для продвижения услуг и привлечения большего числа клиентов. Хотите перейти на бизнес-аккаунт?',
      businessConfirmYes: 'Да, обновить',
      businessConfirmCancel: 'Отмена',
      businessSuccessTitle: 'Добро пожаловать в бизнес!',
      businessSuccessBody: 'Поздравляем! Ваш аккаунт успешно обновлён. Теперь вы можете добавлять услуги и расширять клиентскую базу.',
      businessSuccessContinue: 'Продолжить',
      business: 'Бизнес',
  ...
  pl: {
    ...
    account: {
      ...
      upgrade: 'Ulepsz',
      enableBusiness: 'Włącz konto biznesowe',
      enableBusinessDesc: 'Dodawaj i zarządzaj swoimi usługami, otrzymuj statystyki i docieraj do większej liczby klientów',
      businessEnabled: 'Konto biznesowe zostało pomyślnie włączone!',
      businessConfirmTitle: 'Przejdź na konto biznesowe',
      businessConfirmBody: 'Konta biznesowe odblokowują narzędzia do promowania usług i dotarcia do większej liczby klientów. Czy chcesz przejść na konto biznesowe?',
      businessConfirmYes: 'Tak, uaktualnij',
      businessConfirmCancel: 'Anuluj',
      businessSuccessTitle: 'Witaj w biznesie!',
      businessSuccessBody: 'Gratulacje! Twoje konto zostało pomyślnie zaktualizowane. Możesz teraz dodawać usługi i rozwijać bazę klientów.',
      businessSuccessContinue: 'Kontynuuj',
      business: 'Biznes',
  ...
  lt: {
    ...
    account: {
      ...
      upgrade: 'Patobulinti',
      enableBusiness: 'Įjungti verslo paskyrą',
      enableBusinessDesc: 'Pridėkite ir valdykite savo paslaugas, gaukite statistiką ir pasiekite daugiau klientų',
      businessEnabled: 'Verslo paskyra sėkmingai įjungta!',
      businessConfirmTitle: 'Pereiti prie verslo paskyros',
      businessConfirmBody: 'Verslo paskyros atrakins įrankius paslaugų reklamai ir didesniam klientų skaičiui pasiekti. Ar norite pereiti prie verslo paskyros?',
      businessConfirmYes: 'Taip, atnaujinti',
      businessConfirmCancel: 'Atšaukti',
      businessSuccessTitle: 'Sveiki atvykę į verslą!',
      businessSuccessBody: 'Sveikiname! Jūsų paskyra sėkmingai atnaujinta. Dabar galite pridėti paslaugas ir plėsti klientų bazę.',
      businessSuccessContinue: 'Tęsti',
      business: 'Verslas',
